...
renderPage urlPath = do
  let
    ...
    model = { route: mRoute, page, isHydrated: false, authToken: Nothing, authUsername: Nothing, loginForm: { username: "", password: "" }, accounts: NotAsked, selectedAccount: NotAsked, newAccountForm: { name: "", isBot: false }, editProfileForm: Nothing, editMetadataForm: Nothing, errorMessage: Nothing, savePending: false }
    appView = view model
