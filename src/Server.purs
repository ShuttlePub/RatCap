...
renderPage urlPath = do
  let
    ...
    model = { route: mRoute, page, isHydrated: false, session: Nothing, loginForm: { identifier: "", password: "" }, accounts: NotAsked, selectedAccount: NotAsked, newAccountForm: { name: "", isBot: false }, editProfileForm: Nothing, editMetadataForm: Nothing, errorMessage: Nothing, savePending: false }
    appView = view model
